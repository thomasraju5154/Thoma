...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h1>TH BANKING</h1></a>
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <h1 class="main_text">TH ONLINE BANKING</h1>
          </div>

          <div class="col-sm-6">
            
            <img src="images/123.png" class="img-fluid" width="400" height="235" style="margin-top:20px;">
